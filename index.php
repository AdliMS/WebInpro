...
}elseif (! isset($_SESSION['penerbit'])) {
    header('Location: penulis_page.php');
}
require 'dbconn.php';

$lists = query('SELECT * FROM naskah');
              ...
              <table class="table table-light table-bordered w-100 rounded-3 overflow-hidden">
                  ...
                  <?php foreach($lists as $list) : ?>
                      ...
                      <td socket="col" class="col-3">
                          ...
                          <button name="<?php $list['id_naskah']?>" type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">Terima</button>
                          <a id="hapus" href="delete.php?id=<?= $list['id_naskah'] ?>" class="btn btn-danger">Tolak</a>
